...
* Datasetv3 вместо Datasetv2. Новая версия не возвращает traj_pad_mask и не производит padding траекторий. Padding будет производиться в collarte function. Padding выходной последовательности все еще производится в датасете.
