...
| ![Here should be an image of encoder_input_sequence_element](./assets/images/encoder_input_sequence_element.png) |
|:--:|
...
| ![weights_viz](./assets/images/weights_visualization.png) |
|:--:|
| ![3d_keyboard](./assets/images/3d_keyboard.png) |
...
:-------------------------:|:-------------------------:
![acc_greedy_TRAIN](./assets/images/metrics/greedy_accuracy_epoch_train.png)  |  ![celoss_TRAIN](./assets/images/metrics/celoss_epoch_train.png)
-->
...
<table>
  <tr>
    ...
    <td align="center">
      <img src="./assets/images/metrics/celoss_epoch_train.png" alt="CE Loss (Train Set)" />
    </td>
  </tr>
  <tr>
...
:-------------------------:|:-------------------------:
![acc_greedy_val](./assets/images/metrics/greedy_accuracy_val.png) | ![celoss_val](./assets/images/metrics/celoss_val.png)
-->

<table>
  <tr>
    <td align="center">
      <img src="./assets/images/metrics/greedy_accuracy_val.png" alt="Greedy Decoding Word-Level Accuracy (Validation Set)" />
    </td>
    <td align="center">
...
:-------------------------:|:-------------------------:
![acc_token_val](./assets/images/metrics/token_level_accuracy_val.png) | ![f1_token_val](./assets/images/metrics/token_level_f1_val.png)
-->
