    ...
    * Optionally: keyboard key that has x and y coordinates within its boundaries
    ...
    def __init__(self,
        ...
        self.first_encoder_layer = nn.TransformerEncoderLayer(
            input_size, num_heads_first, dim_feedforward,
            dropout, batch_first=batch_first, device=device)
        ...
        if num_layer_after_first > 0:
            encoder_layer = nn.TransformerEncoderLayer(
                d_model, num_heads_other, dim_feedforward, dropout, batch_first=batch_first, device=device)
...
class SwipeCurveTransformerDecoderv1(nn.Module):
    ...
    def __init__(self,
        ...
        self.decoder_layer = nn.TransformerDecoderLayer(
            char_emb_size, nhead, dim_feedforward, dropout, activation, batch_first, device=device)
