...
1. Для всех моделей, кроме gaussian
      - [] Получить графики всех метрик всех моделей из tensorboard
2. КОгда сделано все что выше Удалить все модели, кроме семейства v3_models
3. Обучить trainable_gaussian
4. Добавить метрики для trainable gaussian
...
7. Рефакторинг train.ipynb и predict_v2.py - минимум 30 минут + спросить gpt как бы он улучшил
8. Попробовать смерджить train.ipynb и train__gaussian.ipynb
9. Попробовать смерджить predict_v2 и predict_trainable_gaussian
10. Обновить README
