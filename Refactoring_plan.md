...
4. Сделать заметку про очень большой трансформер
5. Сделать заметку про старые модели с соревнования
6. Дальше нужно определить чем отличаются три версии train и сделать одну, или по крайней мере, две, если вариант с гауссовскими фичами слишком сильно отличается
