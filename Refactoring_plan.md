Понять, почему не воспроизводится yandex cup:
* Попробовать перестать пропускаьт токены с нулевой вероятностью, посмотреть, что получится
* Попробовать возвращать в конце 7 гипотез (или что логичнее обрезать 7 гипотез из полученного файла)

Сейчас результаты не воспроизводятся. Вроде бы, главное, что изменилось – что  сейчас пропускаю буквы с нулевой вероятностью. Раньше буквы с буквально нулевой вероятностью (с точки зрения обученной модели, а не словаря) входили в множество незоконченных гипотез бимсерча если число букв с ненулевой вероятностью на данном шаге меньше размера луча. Однако, это только значит, что раньше до финальных предсказаний могли добраться слова с нулевой вероятностью, а значит, сейчас предсказаний должно было стать меньше. Однако, их, похоже, наоборот стало больше… 
-----------------
