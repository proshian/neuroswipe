...
6. Добавить метрики для trainable gaussian
      - [] Для скачать чекпоинты, получить из них веса и поставить предсказываться
      - [] Для произвести evaluation
...
7. Обновить README
      ...
      * Сделать заметку про очень большой трансформер
      * Сделать заметку про старые модели с соревнования
