...
1. Продолжить обучение всех моделей (см google doc) пока не будут выполнены все пункты ниже
...
7. Обновить README
      * Уточнить results
      * УточнитьДобавить пометку про обучение с pl (ест память)
      * Уточнить заметку про очень большой трансформер
      * Уточнить заметку про старые модели с соревнования
